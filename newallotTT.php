...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($_POST["faculty"])){
        $faculty_err = "Please select faculty.";     
    }
    else{
    ...
    if(empty($_POST["nums"])){
      $num_session_err = "Please select time slot.";     
  }
  else{
      $num_session = $_POST["nums"];
  }                        
    // Check input errors before inserting in database
    if(empty($year_err) && empty($subject_err) && empty($faculty_err) && empty($num_session_err) ){
        
          // Prepare an insert statement
            $sql = "INSERT INTO `allottime_table`(`year`,`time_slot` , `subject`, `faculty` )  VALUES (?,?,?,?)";
           
          if($stmt = mysqli_prepare($link, $sql)){
              // Bind variables to the prepared statement as parameters
              mysqli_stmt_bind_param($stmt, "ssss",$year,$num_session,$subject,$faculty);
        ...
        <div class="container-fluid">
          ...
          <div class="card">
                ...
                <div class="form-group">
                    ...
                    <select
                        class="form-select <?php echo (!empty($faculty_err)) ? 'is-invalid' : ''; ?>" 
                        name ="faculty"
                      >
                    ...
                    <option value=""> Select Faculty </option>
                      ...
                      <option value="CD">Charles Darwin</option>
                      <option value="AL">Ada Lovelace</option>
                      <option value="MC">Marie Curie</option>
                      <option value="P">Pythagoras</option>
                      <option value="IN">Isaac Newton</option>
                ...
                <!-- number of sessions -->
                  <div class="form-group">
                    ...
                    <option value=""> Select Time Slot </option>
                      ...
                      <option value="">9:00AM to 10AM</option>
                      <option value="10-11">10:00AM to 11:00AM</option>
                      <option value="11-12">11:00AM to 12:00PM</option>
                      <option value="12:30-1:20">12:30PM to 01:20PM</option>
                      <option value="1:20-2">01:20PM to 2:00PM</option>
